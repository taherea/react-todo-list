...
const ModalAdd = ({ setShowModal ,handleSubmit,handleChange,titleInput,handleSelect,handleDateChange,handleTimeChange}) => (
  <>
    <div
        ...
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-end p-5">
              ...
              <button
                className="bg-blue-400 inline-block py-2 px-4 text-white font-semibold rounded"
                type="sumbit"
                disabled={!titleInput}
              >
                Add
